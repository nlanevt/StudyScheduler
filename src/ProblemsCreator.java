...
public class ProblemsCreator {
	...
	private int MAX_MATH_PROBLEMS = 2;
	private int MAX_CS_PROBLEMS = 0;
	
	
	public ProblemsCreator(ResourceCache cache, int data_problems_amount, int alg_problems_amount) {
	...
	private ArrayList<String> generateResourceProblems(boolean isOrdered) {
		...
		result.addAll(getNewChapterOfType(Field.MATH, MAX_MATH_PROBLEMS, isOrdered));
